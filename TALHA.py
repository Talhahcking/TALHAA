...
ku='\033[33;1m' #KUNING
echo
echo $i"Selamat datang di tools TALHA
echo
sleep 6
clear
echo
...
echo $ku"█"$bi"  WhatsApp:  01608382209"$ku"            █"
echo $bi"█"$bi"  Website.  :  teamcsb.com"$bi"    █"
echo $i"█"$bi"  Facebook :  TALHA"$i"             █"
[24/7 16:15] TALHA: echo $me"==================="$ku" ==================="
echo
...
figlet -f slant "Lest G O ."|lolcat
sleep 1
[24/7 16:16] TALHA: pkg update && pkg upgrade
pkg install git
pkg install python2
...
cd 13
[24/7 16:16] TALHA: php profile.php
fi
...
[24/7 16:17] TALHA: echo $i"selanjutnya dari saya OKE"
sleep 2
echo
echo $cy"Thanks FOR VISITING....!!!"
exit
fi
